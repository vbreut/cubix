    ...
    if(found[0]>0){
        ...
        if(solutions[shorter][4]==0 && solutions[shorter][3]==0 && solutions[shorter][2]==0){//1 case de déplacement
            ...
            if(c[0]==0){//si pas de capture à l'arivée on joue
                ...
                currentcell= document.getElementById("cell-" + solutions[shorter][0]);
        ...
        if(solutions[shorter][4]==0 && solutions[shorter][3]==0 && solutions[shorter][2]!=0){//2 cases
            moveCubeTosimu(solutions[shorter][0],solutions[shorter][1]);
            moveCubeTosimu(solutions[shorter][1],solutions[shorter][2]);
            ...
            if(c[0]==0){//si pas de capture à l'arivée on joue
                ...
                setTimeout(() => {
                    selectedcell = document.getElementById("cell-" + solutions[shorter][2]);
                    moveCubeTo3(selectedcell, light);
                }, 500);
                return 1;
            }
        ...
        if(solutions[shorter][4]==0 && solutions[shorter][3]!=0){//3 cases
            moveCubeTosimu(solutions[shorter][0],solutions[shorter][1]);
            moveCubeTosimu(solutions[shorter][1],solutions[shorter][2]);
            ...
            moveCubeTosimu(solutions[shorter][2],solutions[shorter][3]);
            prisesimu(cubeid);
            c2=capture(cubeid);
        ...
        if(solutions[shorter][4]!=0){//4 cases
            ...
            moveCubeTosimu(solutions[shorter][2],solutions[shorter][3]);
            moveCubeTosimu(solutions[shorter][3],solutions[shorter][4]);
            prisesimu(cubeid);
            c2=capture(cubeid);
